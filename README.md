...
1. **Install GitHub**: Install the command line version of git on your computer [Git Guides - install git (github.com)](https://github.com/git-guides/install-git) 
...
```
 ...
 Before running the command it is best practice to copy the following files over to a new directory and run the above command from there.
